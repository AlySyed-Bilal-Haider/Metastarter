...
function Lunchproject() {
  return <>
      <Grid container style={{padding:'5%'}} sx={{ overflowX:'hidden',color:'white',width:'100%',backgroundColor:"#0A000C"}}>
          <Grid item md={6}>
              <Typography variant='h4' className="text-gradient" sx={{p:3}}>Launch <Typography variant='h4' sx={{fontWeight:'bold',display:'inline-block'}}>Project</Typography> </Typography>
              <Typography width="88%" style={{marginLeft:'5%',fontSize:{
                  lg:22,
                  md:18,
                  sm:16,
                  xs:12
